...
function Hooks() {
  ...
  return (
    <div className=''>
        ...
        <div className='m-4'>
        <input type="text" onChange={onChange} name="name" id='name' ref={inputRef} value={name} className='my-4 g-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 pl-10 p-2.5' />
        ...
        <div className='m-3'>
            ...
            <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4' onClick={()=> subtract()}>subtract</button>
        </div>
        <p>{show}</p>
    </div>
  )
